...
def Application(root):
    ...
    # frame1 widgets
    name1 = Label(frame1, text="PDF Reader", fg="black", bg="HotPink3",
                  font="Arial 28 bold")
    name1.pack()

    name2 = Label(frame1, text="Hear your PDF File", fg="black", bg="HotPink3",
                  font="Calibre 25 bold")
    name2.pack()

    # frame2 widgets
    btn = Button(frame2, text="Select PDF File", activebackground="red",
                 command=extract_text, padx="70", pady="10", fg="white",
                 bg="black", font="Arial 12")
    btn.grid(row=0, pady=20, columnspan=2)

    rate_text = Label(frame2, text="Enter Speech Rate", fg="black",
                      bg="aqua", font="Arial 12")
    rate_text.grid(row=1, column=0, pady=15, padx=0, sticky=W)
    rate = Entry(frame2, fg="black", bg="white",
                 font="Arial 12")
    rate.grid(row=1, column=1, padx=30, pady=15, sticky=W)

    voice_text = Label(frame2, text="Select  Voice", fg="black",
                       bg="aqua", font="Arial 12")
